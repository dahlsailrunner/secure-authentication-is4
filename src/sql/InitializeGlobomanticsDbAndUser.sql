...
EXEC sp_addrolemember N'db_datareader', [globo_identityserver];
EXEC sp_addrolemember N'db_datawriter', [globo_identityserver];
GRANT EXECUTE TO [globo_identityserver];